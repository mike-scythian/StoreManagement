...
const baseUrl = 'http://localhost:8181/summary/stores/by-period/'
const prodUrl = 'http://localhost:8181/products'
const storeUrl = 'http://localhost:8181/stores'

const SummaryByStoreForPeriod =() => {
    ...
    const handlePageClick = (page) =>{
        console.log("click")
        axios(baseUrl + localId.id + "?page=" + page.selected)
            .then(response => {
...
export default SummaryByStoreForPeriod